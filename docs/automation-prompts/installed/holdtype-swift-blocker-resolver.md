...
automationId: holdtype-swift-blocker-resolver
status: paused
...
| Field | Value |
| --- | --- |
| id | `holdtype-swift-blocker-resolver` |
| kind | `cron` |
| name | `HoldType Swift Blocker Resolver` |
| status | `PAUSED` |
...
| updated_at | `1783281212037` / `2026-07-05T19:53:32.037000Z` |
| promptSource | `docs/automation-prompts/runbooks/holdtype-swift-blocker-resolver.md` |
| sourceSnapshot | `/Users/eugenepotapenko/.codex/automations/holdtype-swift-blocker-resolver/automation.toml` |
| promptLength | `888` characters |
