...
- `/opt/homebrew/bin/timeout 300 xcodebuild -project holdtype.xcodeproj -scheme holdtype -destination 'platform=macOS' build`
...
- Build product:
  `/Users/eugenepotapenko/Library/Developer/Xcode/DerivedData/holdtype-cgljxvuvdfxmqbeiqfwkdshvjovc/Build/Products/Debug/holdtype.app`.
