...
Finder-owned review, Build/Export/Share, separate SwiftUI window, and development menu.
...
- [Authority and release](dev-vlogs/authority-and-release.md) — active deltas,
  `1.0.11` exclusion, restored development access, compatibility, and deferred publication.
...
- [Window and product states](dev-vlogs/window-and-states.md) — development menu, SwiftUI sections, presentation states, and lifecycle enums.
