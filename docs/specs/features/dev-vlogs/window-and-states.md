...
- Product name is Dev Vlogs; V1 commands are app-only. The current development
  menu includes `Dev Vlogs…` for local Xcode testing. HoldType `1.0.11` and `1.0.12` remain
  excluded public releases; a later public shipping claim requires an
