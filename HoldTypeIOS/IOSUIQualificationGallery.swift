...
fileprivate enum IOSUIQualificationVoiceScenario: Sendable {
    ...
    var progress: [IOSForegroundVoiceProgress] {
        ...
        case .listening:
            [.listening(.default)]
        case .finalizing:
            [.listening(.default), .finalizing]
        case .processing:
            [.listening(.default), .finalizing, .processing(.transcription)]
        case .postProcessing:
            [.listening(.default), .finalizing, .processing(.postProcessing)]
        case .outputDelivery:
            [.listening(.default), .finalizing, .processing(.outputDelivery)]
