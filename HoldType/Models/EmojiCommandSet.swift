...
struct EmojiCommandAlias: Equatable, Identifiable {
...
struct EmojiCommand: Equatable, Identifiable {
    let id: String
    let emoji: String
    let displayName: String
    let aliases: [String]

    init(id: String, emoji: String, displayName: String, aliases: [String]) {
        self.id = id
        self.emoji = emoji
    ...
    var primarySpokenPhrase: String {
        aliases.first ?? ""
    }

    var secondarySpokenPhrases: [String] {
        Array(aliases.dropFirst())
    }

    var replacementAliases: [EmojiCommandAlias] {
    ...
    static func normalizedSpokenPhrase(_ phrase: String) -> String {
        phrase
    ...
    static func normalizedSpokenPhrases(_ phrases: [String]) -> [String] {
...
struct CustomEmojiCommand: Codable, Equatable, Identifiable {
    var id: UUID
    var emoji: String
    var command: String
    var aliases: [String]
    ...
    var normalizedSpokenPhrases: [String] {
    ...
    var hasUsableCommand: Bool {
        !normalizedEmoji.isEmpty && !normalizedSpokenPhrases.isEmpty
    }

    var normalizedForStorage: CustomEmojiCommand {
...
struct EmojiCommandSet: Equatable, Identifiable {
    let id: String
    let displayName: String
    let commands: [EmojiCommand]

    var aliases: [EmojiCommandAlias] {
    ...
    static let builtIn: [EmojiCommandSet] = [
        EmojiCommandSet(
            id: "en",
            displayName: "English",
            commands: [
    ...
    static func normalizedBuiltInIDs(_ ids: [String]) -> [String] {
        for id in ids {
