...
TARGET_CWD = "/Users/eugenepotapenko/Projects/potapenko-github/holdtype-swift"
                ...
                "content": [
                    {
                        "type": "input_text",
                        "text": (
                            "Automation: HoldType Swift Archive Completed Automation Threads\n"
...
class HoldTypeArchiveCodexThreadsTest(unittest.TestCase):
    def setUp(self) -> None:
        self.tempdir = tempfile.TemporaryDirectory()
        self.codex_home = Path(self.tempdir.name)
        (self.codex_home / "automations" / "holdtype-swift-archive-completed-automation-threads").mkdir(
            parents=True
        )
        (self.codex_home / "automations" / "holdtype-swift-implementer").mkdir(
            parents=True
        )
