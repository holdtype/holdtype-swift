...
REQUIRED_PATHS = (
    ...
    "website/i18n/ar.json",
    "website/i18n/de.json",
    "website/i18n/en.json",
    "website/i18n/es.json",
    "website/i18n/fr.json",
    "website/i18n/ja.json",
    "website/i18n/ko.json",
    "website/i18n/locales.json",
    "website/i18n/pt-BR.json",
    "website/i18n/ru.json",
    "website/i18n/site.json",
    "website/i18n/zh-Hans.json",
    "website/index.html",
    "website/script.js",
    "website/styles.css",
)
