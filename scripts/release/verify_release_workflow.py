...
EXPECTED_STEP_ORDER = (
    ...
    "Deploy site and appcast to Pages",
...
REQUIRED_FRAGMENTS = {
    ...
    "generate-appcast:release-notes-url-prefix": "--release-notes-url-prefix",
    ...
    "publish:stable-dmg-name": 'dmg="$RELEASE_DIR/HoldType.dmg"',
    ...
    "publication:concurrency-group": "group: holdtype-publication",
    "publication:concurrency-queue": "queue: max",
    "script:prepare-pages-artifact": "scripts/release/prepare_pages_artifact.py",
    "pages:website-dir": "--website-dir website",
    "pages:current-release-notes": "--current-release-notes \"${{ steps.release-notes.outputs.path }}\"",
    "pages:configure": "actions/configure-pages@v6",
    "pages:upload": "actions/upload-pages-artifact@v5",
    "pages:deploy": "actions/deploy-pages@v5",
    ...
    "homebrew:official-artifact-upload": "actions/upload-artifact@v7",
