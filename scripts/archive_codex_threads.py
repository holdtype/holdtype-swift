...
DEFAULT_TARGET_CWD = "/Users/eugenepotapenko/Projects/potapenko-github/holdtype-swift"
HOUSEKEEPING_ID = "holdtype-swift-archive-completed-automation-threads"
...
def archive_once(
    *,
    ...
    backup_path = state_db.with_name(
        f"{state_db.name}.bak-holdtype-thread-cleanup-{now}"
    )
