...
- Disposition: The exploratory minimal iOS containing app target already exists, and any
  further simulator/MCP proof is future v2 scope. This task is removed from
  the active macOS backlog.
