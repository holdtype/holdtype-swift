...
- Disposition: Closed as deferred/cancelled from the active macOS MVP backlog. Keyboard
  extension target work is future v2 scope and should not be selected by
  normal macOS agents.
