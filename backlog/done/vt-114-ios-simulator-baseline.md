...
- Disposition: Closed as deferred/cancelled from the active macOS MVP backlog. iOS
  simulator baseline work belongs only to explicit future v2 iOS runs, not
  normal VibeType macOS work.
