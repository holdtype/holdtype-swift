...
- Disposition: MVP behavior toggles are already implemented in Settings and bound through
  AppSettings persistence, including automatic insertion, VibeType Clipboard,
  sound, floating indicator, recording tail, and recovery-history controls.
