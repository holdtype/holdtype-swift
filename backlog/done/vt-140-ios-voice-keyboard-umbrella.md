...
- Disposition: Closed as deferred/cancelled from the active macOS MVP backlog. iOS voice
  keyboard work remains future v2 scope and should only be reopened by an
  explicit v2 request.
