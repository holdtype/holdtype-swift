...
For HoldType Swift, pay special attention to macOS menu bar behavior,
microphone capture, OpenAI transcription, privacy, permissions, timeout
behavior, Keychain API key storage, auto-paste, clipboard fallback, and output
handoff.
